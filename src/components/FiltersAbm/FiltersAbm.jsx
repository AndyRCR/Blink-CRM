...
import './FiltersAbm.css'


const FiltersAbm = ({ displayed}) => {
  return (
                        ...
                        <div className='filtercolumn'>
                          ...
                          <FormGroup>
                            <FormControlLabel
                                ...
                                control={<Checkbox  
                                sx={{
                                  '& .css-gjtbb4-MuiButtonBase-root-MuiCheckbox-root': {
                                    background: 'red', }
                                }}
                                 />}
                                label='Todos'/>         
                    ...
                    <div className="filterItem">
                        ...
                        <FormControl sx={{ width: '330px' }}>
                            ...
                            >
                                ...
                                <MenuItem value={'opcion1'}>Opcion1</MenuItem>
                                <MenuItem value={'opcion2'}>opcion2</MenuItem>
                            </Select>
                        </FormControl>
                    </div>
                    <div className="filterItem">
                        <label>Niveles</label>
                        <div className='filtercolumn nivels'>
                          <div className='flexcolumn'>
                          <FormGroup>
                            <FormControlLabel
                                sx={{
