...
import ModalExportarInformacion from '../ModalExportarInformacion/ModalExportarInformacion'
    ...
    return (
        <div className='clientesFilter'>
            <div className="filterItem paginationFilter">
                ...
                <p>{window.location.pathname === '/clientes' ? 'Clientes por' 
                    : (window.location.pathname === '/ventas' ? 'Ventas por' : 'Por')} página</p>
            </div>
            ...
            <div className='filterButtons'>
                ...
                <div className="filterItem">
                    <button className='buttonVariant' style={{ maxWidth: '168px' }} onClick={handleOpen} >
                ...
                {window.location.pathname === '/cotizador' || window.location.pathname === '/ventas' || window.location.pathname === '/abm' ? (
                    <div className="filterItem">
...
{window.location.pathname === '/ventas' || window.location.pathname === '/abm' || window.location.pathname === '/cotizador' || window.location.pathname === '/clientes' ? (
    <div className="filterItem">
        <button
            ...
            {window.location.pathname === '/ventas' || window.location.pathname === '/cotizador' || window.location.pathname === '/clientes' ? 'Nueva cotización' : 'Crear cuenta'}
        </button>
    </div>
) : false}
        ...
        <ModalExportarInformacion open={open} handleClose={handleClose} />
